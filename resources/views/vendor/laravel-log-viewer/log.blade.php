...
<div class="container-fluid">
    <div class="row">
        <div class="col sidebar mb-3">
            <h1><i class="fa fa-calendar" aria-hidden="true"></i> 系统响应日志 </h1>
                    ...
                    @if(count($files) > 1)
                        ...
                        <a id="delete-all-log"
                           href="?delall=true{{ ($current_folder) ? '&f=' . \Illuminate\Support\Facades\Crypt::encrypt($current_folder) : '' }}">
                            <span class="fa fa-trash-alt"></span> 删除所有
                        </a>
                    @endif
                @endif
            </div>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<!-- FontAwesome -->
<script defer src="/log-viewer/laravel-log-viewer-all.js"></script>
<!-- Datatables -->
<script type="text/javascript" src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="/log-viewer/dataTables.bootstrap4.min.js"></script>
<script>
